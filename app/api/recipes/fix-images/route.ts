...
function fixSpoonacularImageUrl(imageUrl: string | undefined, recipeId: string): string | undefined {
  ...
  try {
    ...
    snapshot.forEach(doc => {
      ...
      if (fixedImageUrl && fixedImageUrl !== currentImageUrl) {
        ...
        fixedCount++;
        console.log(`Fixed image for ${doc.id}: ${currentImageUrl} -> ${fixedImageUrl}`);
      }
    });
