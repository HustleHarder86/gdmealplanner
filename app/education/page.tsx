  ...
  const articles = [
    {
      ...
      description: 'Learn the basics of GD, why it happens, and what it means for your pregnancy.',
      readTime: '8 min',
      category: 'Basics',
    },
    {
      ...
      description: 'Master the art of counting carbohydrates to manage your blood sugar effectively.',
      readTime: '10 min',
      category: 'Nutrition',
    },
    {
      ...
      description: 'Discover safe and effective exercises to help manage your glucose levels.',
      readTime: '6 min',
      category: 'Exercise',
    },
    {
    ...
    },
    {
      ...
      description: 'Tips and strategies for dealing with the dawn phenomenon in pregnancy.',
      readTime: '5 min',
      category: 'Management',
    },
    {
    ...
    <div className="container py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
          Evidence-based information to help you understand and manage gestational diabetes effectively.
        </p>
      </div>
