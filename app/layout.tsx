...
export const metadata: Metadata = {
  ...
  description: 'Manage gestational diabetes with personalized meal plans, glucose tracking, and expert nutrition guidance for a healthy pregnancy.',
  keywords: 'gestational diabetes, meal planning, pregnancy nutrition, glucose tracking, GD diet',
        ...
        <footer className="bg-white border-t border-neutral-200 mt-12">
          <div className="container py-8">
            <p className="text-center text-sm text-neutral-600">
              © 2025 Pregnancy Plate Planner. Always consult your healthcare provider.
            </p>
          </div>
        </footer>
      </body>
