...
const testRecipe = {
  recipe: {
    ...
    description: "A delicious and nutritious quinoa bowl perfect for gestational diabetes management.",
...
async function testAPI() {
  ...
  try {
    ...
    console.log(`🥗 Nutrition: ${testRecipe.recipe.nutrition.carbs}g carbs, ${testRecipe.recipe.nutrition.protein}g protein\n`);
    ...
    console.log('3. Check that the API route exists at app/api/import-recipe/route.ts');
  }
}
