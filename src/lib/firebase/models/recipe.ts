...
export class RecipeModel {
  ...
  static async batchSave(recipes: Recipe[]): Promise<void> {
    try {
      ...
      throw new Error(
        `Failed to batch save recipes: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  }
  ...
  static async getByCategory(
    ...
    try {
      ...
      throw new Error(
        `Failed to get recipes by category: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  }
  ...
  static async getAllIds(): Promise<string[]> {
    try {
      ...
      throw new Error(
        `Failed to get recipe IDs: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  }
