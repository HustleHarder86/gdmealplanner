...
export const BREAKFAST_STRATEGIES: ImportStrategy[] = [
  ...
  },
  {
    ...
    filters: {
      query: "avocado toast vegetables",
      maxCarbs: 45,
      type: "breakfast",
      ...UNIVERSAL_FILTERS,
    },
  ...
  },
  {
    ...
    filters: {
      query: "greek yogurt cottage cheese",
      maxCarbs: 35,
      minProtein: 10,
      type: "breakfast",
      ...UNIVERSAL_FILTERS,
  ...
  },
  {
    ...
    filters: {
      query: "pancakes waffles french toast",
      maxCarbs: 50,
      type: "breakfast",
      ...UNIVERSAL_FILTERS,
    },
...
export const LUNCH_STRATEGIES: ImportStrategy[] = [
  ...
  },
  {
    ...
    filters: {
      query: "sandwich wrap chicken turkey",
      maxCarbs: 55,
      type: "main course",
      ...UNIVERSAL_FILTERS,
    },
